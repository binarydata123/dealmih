        ...
        <div class="container">
            <div class="row">
                ...
                <div class="webads-image ">
                    ...
                    <img src="{{url('/media/webads-image',$webads->image)}}" class="iresponsive" id="webads_image"></a>
                    @else
                     <img src="{{url('/media/webads-image',$webads->image)}}" class="iresponsive" id="webads_image">
                     @endif
                @else 
                 <img src="{{ asset('website/images/dea/ad.png') }}" class="iresponsive">
                @endif
                </div>
            </div>
                                   ...
                                   <div class="product-media resimg">
                                       ...
                                       <div class="product-img">
                                           @if ($premiumProduct->image)
                                               <img src="{{ asset('media/product-image/' . $premiumProduct->image) }}"
                                                   alt="product">
                                    ...
                                    <div class="product-media resimg">
                                        ...
                                        <div class="product-img">
                                            @if ($auctionProduct->image)
                                                <img src="{{ asset('media/product-image/' . $auctionProduct->image) }}"
                                                    alt="product">
                                            @else<img src="{{ asset('website/images/no-image.png') }}"
                                                    alt="product">
                                            @endif
                                        ...
                                        <div class="product-media resimg">
                                            ...
                                            <div class="product-img">
                                                @if ($recommendedProduct->image)
                                                    <img src="{{ asset('media/product-image/' . $recommendedProduct->image) }}"
                                                        alt="product">
                                                @else<img src="{{ asset('website/images/no-image.png') }}"
                                                        alt="product">
                                                @endif
