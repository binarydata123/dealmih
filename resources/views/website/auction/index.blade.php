                                        ...
                                        <div>
                                            ...
                                            <a href="{{ url('product/detail/' . $auction->slug) }}">
                                                <div class="product-img">
                                                    @if ($auction->image)
                                                        <img src="{{ asset('media/product-image/' . $auction->image) }}"
                                                            alt="product">
                                            ...
                                            <a href="{{ url('product/detail/' . $marketPlace->slug) }}">
                                                <div class="product-img">
                                                    @if ($marketPlace->image)
                                                        <img src="{{ asset('media/product-image/' . $marketPlace->image) }}"
...
@endsection
@section('js')
<script src="{{asset('website/js/classified/delete.js')}}"></script>
