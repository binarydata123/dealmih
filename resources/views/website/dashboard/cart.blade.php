                                            ...
                                            <div class="product-card standard image-heg remove-flex">
                                                <div class="row">
                                                    ...
                                                    <div class="product-img">
                                                         <img @if($cart) src="{{ asset('media/product-image/'.$cart->image) }}" 
                                                         @else src="{{ asset('website/images/product/07.jpg') }}"  @endif
                                                            alt="product"></div>
                                                    </a>
                                                </div>
                                                    </div>
                                                    ...
                                                    <div class="product-info text-cont">
                                                        ...
                                                        {{-- <a href="#!" class="wishlist" data-id="{{$cart->id}}"><span class="fs14r "><img
                                                                    src="{{ asset('website/images/dea/file-download.svg') }}">WishList
                                                                </span></a> --}}
