                ...
                <div class="col-lg-6 _boxzoom">
                    ...
                    <div class="_product-images" align="center">
                        <div class="picZoomer" align="center">
                            @if($product->image)
                            <img class="my_img" src="{{ asset('media/product-image/'.$product->image) }}" alt="">
                            @endif
                        </div>
                        ...
                        <div class="common-card dbox2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mtm30">
                                    <img class="iresponsive" @if ($product->seller_image) src="{{ asset('media/seller-image/' . $product->seller_image) }}"  height="124" width="124" @else src="{{ asset('website/images/dea/p1.png') }}" @endif alt="">
                                </div>
