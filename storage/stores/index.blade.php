   ...
   <div class="col-md-6 col-lg-3">
      <div class="blog-card">
         <div class="blog-img resimg">
            ...
            @else src="{{asset('website/images/blog/02.jpg')}}" @endif alt="blog">
         </div>
         <div class="blog-content h240">
            ...
            <a href="{{url('store-profile',$store->user_id)}}" class="blog-avatar"><img @if($store->company_log)
                ...
                @else  src="{{asset('website/images/dea/job/dp.png')}}" @endif alt="avatar"></a>
            <div class="blog-text">
        ...
        $avgRating = $produstReviews->avg('rating');
            ...
            <a href="{{url('store-profile',$store->user_id)}}" class="tblack">
             ...
             <br>
            <a href="{{url('store-profile',$store->user_id)}}#product_section" class="blog-read"><span>View Store</span><i class="fas fa-long-arrow-alt-right"></i></a>
