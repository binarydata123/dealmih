...
@section('css')
<link rel="stylesheet" href="{{asset('website/css/custom/interested-categories.css')}}">
@endsection
@section('content')
                                ...
                                <ul class="icc">
                                        ...
                                        @foreach ($categories as $key => $category)
                                            <li>
                                                ...
                                                <label for="myCheckbox{{ $key + 1 }}" class="bshadow resimgcat"><img
                                                       ...
                                                       src="{{asset('media/category-image/'.$category->thumbnail)}}"  @else src="{{ asset('website/images/dea/c1.png') }}" @endif />
                                    ...
                                    {{-- <li>
                                        ...
                                        <label for="myCheckbox2" class="bshadow"><img
                                                src="{{ asset('website/images/dea/c2.png') }}" />
                                    ...
                                    {{-- <li>
                                        ...
                                        <label for="myCheckbox3" class="bshadow"><img
                                                src="{{ asset('website/images/dea/c3.png') }}" />
                                    ...
                                    <li>
                                        ...
                                        <label for="myCheckbox4" class="bshadow"><img
                                                src="{{ asset('website/images/dea/c4.png') }}" />
