                        ...
                        <div class="tab-wrap">
                            ...
                            <div class="tab-item-wrap">
                                <div class="title mb20">
                                    <h6><span><img src="{{asset('website/images/tag.png')}}" width="15px"></span> {{ucwords($headerCategory->name)}} <span class="floatr"> <i class="fa fa-angle-down frr" aria-hidden="true"></i></span> </h6>
                                </div>
                                <div class="content">
...
<input type="text"  hidden class="category-value" id="">
                                ...
                                <div class="product-card">
                                    ...
                                    <a href="{{url('product/detail/'.$product->slug)}}">
                                        <div class="product-img">
                                            @if ($product->image)
                                                        <img src="{{ asset('media/product-image/' . $product->image) }}"
                                                            alt="product">
                        ...
                        @endif
                                ...
                                <div class="product-media resimg">
                                    <a href="#!">
                                        <div class="product-img"><img
                                                src="{{ asset('website/images/dea/motor/c2.jpg') }}" alt="product"></div>
                            ...
                            {{-- <div class="product-card">
                                <div class="product-media resimg">
                                    <a href="#!">
                                        <div class="product-img"><img
                                                src="{{ asset('website/images/dea/motor/c3.jpg') }}" alt="product"></div>
                            ...
                            {{-- <div class="product-card">
                                <div class="product-media resimg">
                                    <a href="#!">
                                        <div class="product-img"><img
                                                src="{{ asset('website/images/dea/motor/c4.jpg') }}" alt="product"></div>
          ...
          <div class="container-fluid">
             <div class="row">
                ...
                <div class="col-lg-3">
                   ...
                   <img src="{{ asset('website/images/dea/1.jpg') }}" class="iresponsive">
            ...
            <div class="row pr30">
                ...
                <img src="{{ asset('website/images/dea/2.jpg') }}" class="iresponsive">
    ...
    <a href="#!" class="btn btn-inline post-btn"><span>Discover</span></a>
                ...
                <img src="{{ asset('website/images/dea/3.jpg') }}" class="iresponsive mt20">
                ...
                <img src="{{ asset('website/images/dea/4.jpg') }}" class="iresponsive">
                ...
                <div class="col-lg-12 bshadow p10">
                <img src="{{ asset('website/images/dea/5.jpg') }}" class="iresponsive mt20">
...
$(document).ready(function(){
  $('.dropdown-submenu a.test').on("click", function(e){
    ...
    <script src="{{ asset('website/js/classified/search.js') }}"></script>
    <script>
        $(document).on('change', '.district', function(e) {
            var id = $(this).val();
            var sel = $('.municipality');
