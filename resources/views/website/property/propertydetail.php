             ...
             <div class="col-lg-6 _boxzoom">
                ...
                <div class="_product-images" align="center">
                   <div class="picZoomer" align="center">
                      ...
                      <img class="my_img" src="@if($property->image){{asset('media/product-image/' . $property->image)}}@else{{asset('website/images/dea/property/l6.jpg')}}@endif" alt="">
                   </div>
                   ...
                   <div class="common-card dbox2">
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-3 mtm30">
                            <img class="iresponsive" src="{{asset('website/images/dea/p1.png')}}" alt="">
                         </div>
