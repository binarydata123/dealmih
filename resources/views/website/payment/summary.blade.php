            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="account-title plr20 mb60 b0 mb60">
                        <li class="active"><img src="{{ asset('website/images/dea/tick.png') }}"> ADDRESS</li>
                        <li>
                            <hr class="wizard">
                        </li>
                        <li class="active current"><img src="{{ asset('website/images/dea/tick.png') }}"> ORDER SUMMARY</li>
                        <!-- <li>
                            <hr class="wizardg">
                        </li> -->
                        <!-- <li>PAYMENT</li> -->
                                ...
                                <div class="product-card standard image-heg">
                                    <div class="product-media">
                                        ...
                                        <div class="product-img" id="cart-imgs" >
                                            @if($cart->image != '')
                                             <img src="{{ asset('media/product-image/'.$cart->image) }}" alt="product">
                                             @else
                                             <img src="{{ asset('website/images/no-image.png') }}" alt="product">
                                             @endif
                                         </div>
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        ...
                                        <div class="product-info text-cont">
                                            <a href="#!" class="delete" data-content="cart" data-id="{{$cart->cart_id}}"> <span class="fs14r"><img 
                                                        src="{{ asset('website/images/delete.svg') }}"> Delete</span></a>
...
<script src="{{asset('website/js/classified/cart.js')}}"></script>
