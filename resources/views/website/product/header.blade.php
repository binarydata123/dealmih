...
<section class="user-form-part">
    ...
    <div class="user-form-category">
       <!-- <div class="user-form-header"><a href="#"><img src="{{asset('website/images/logo.png')}}" alt="logo"></a><a href="{{url('/')}}"><i class="fas fa-arrow-left"></i></a></div> -->
             ...
             <ul class="topUl">
               ...
               <li class="ddList">
                 ...
                 <a href="{{url('create/listing',$headerCategory->slug)}}" title="{{$headerCategory->name}}">
                   ...
                   @else
                    src="{{asset('website/images/dea/review.png')}}" 
                    @endif
