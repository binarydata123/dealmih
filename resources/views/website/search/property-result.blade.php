                        ...
                        <div class="col-lg-6">
                            @if (isset($product->media))
                                @foreach (collect($product->media)->forPage(1, 2) as $media)
                                    <img src="{{ asset('media/product-multi-image/' . $media->file) }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px;"> 
                                @endforeach
                            @else
                                <img src="{{ asset('media/product-image/NoImageFound.png') }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px;">
                                <br>
                                <br>
                                <img src="{{ asset('media/product-image/NoImageFound.png') }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px;">
                            @endif
