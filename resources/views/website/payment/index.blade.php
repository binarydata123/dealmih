            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="account-title plr20 mb60 b0 mb60">
                        ...
                        <li class="active"><img src="{{ asset('website/images/dea/tick.png') }}"> ORDER SUMMARY
                        </li>
                        <li>
                            <hr class="wizard">
                        </li>
                        <li class="active current"><img src="{{ asset('website/images/dea/tick.png') }}"> CHECKOUT</li>
                    </ul>
                </div>
            </div>
            <!-- <div class="row">
                                    ...
                                    <div class="product-card standard image-heg mt20 mb20">
                                        ...
                                        <div class="product-content">
                                            <div class="row mt20">
                                                ...
                                                <div align="center">
                                                    <img src="{{asset('website/images/dealmih.jpg')}}" style="width: 60%">
                                                </div>
