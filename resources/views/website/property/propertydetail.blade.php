                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-offset-3">
                            ...
                            <div class="slider-for">
                                ...
                                <a href="{{ asset('media/product-image/' . $property->image) }}" class="item-slick"><img class="w-100 nav-single_image" src="{{ asset('media/product-image/' . $property->image) }}" alt="Alt"></a>
                            ...
                            <div class="slider-nav mt-2 mb-2">
                                ...
                                <div class="item-slick mr-2"><img class="nav_gakllery w-100 h-50" src="{{ asset('media/product-image/' . $property->image) }}" alt="Alt"></div>
                    ...
                    <div class="common-card dbox2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mtm30">
                                <img class="iresponsive" src="{{asset('website/images/us.png')}}" alt="">
                            </div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-4">
                        <div class="_product-images" align="center">
                            <div align="center">
                                @if ($property->image)
                                <img class="iresponsive bshadow" src="{{ asset('media/product-image/' . $property->image) }}" alt="">
                                @else
                                 <img class="w-100 mb-4" src="{{ asset('website/images/no-image.png') }}" alt="product">
                                @endif
