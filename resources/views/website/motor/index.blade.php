                       ...
                       @if($webads->ne_title != 'url')
                        <a target="_blank" href="{{$webads->ne_title}}">
                           ...
                           @else
                            ...
                            @endif
                            @else 
                        <img src="{{ asset('website/images/dea/job.jpg') }}" class="img-responsive">
                        @endif
                    </div>
                </div>
                                        ...
                                        <div class="product-img">
                                            @if ($product->image)
                                                        <img src="{{ asset('media/product-image/' . $product->image) }}"
                                                            alt="product">
                                                    @else <img src="{{ asset('website/images/no-image.png') }}" alt="product">
                                                    @endif
                                            </div>
                                            </a>
...
@section('js')
    ...
    {{-- <script src="{{asset('website/js/classified/wishlist.js')}}"></script> --}}
    <script>
        var category = "";
        var subCategory = "";
