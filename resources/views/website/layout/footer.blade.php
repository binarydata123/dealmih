           ...
           <div class="row">
              <div class="container">
                 <div class="footer-end-content logbtn">
                    <a href="{{ url('/') }}" class="sidebar-logo"><img src="{{asset('website/images/footer-logo.png')}}" alt="logo"></a>
                     <!-- <ul class="store-img">
                        <li class="mr-3">
...
<!--                        <li><a href="{{url('stores')}}">Store</a></li>
 -->                      
           ...
           <div class="container">
              <div class="footer-end-content">
                 ...
                 <!-- div class="footer-right"> -->
                    <!-- <h5>We Accept : </h5>  <img src="{{asset('website/images/pay-card/02.jpg')}}" width="30">
                    <img src="{{asset('website/images/pay-card/mc.png')}}">
                    <img src="{{asset('website/images/pay-card/up.png')}}" width="30">
                    <img src="{{asset('website/images/pay-card/bt.png')}}"> -->
                  </span>
                    <!-- <ul class="footer-social">
     ...
     <div class="modal fade" id="language">
       ...
       <script src="{{asset('website/js/custom/slick.js')}}"></script>
       <script src="{{asset('website/js/custom/main.js')}}"></script>
       <script src="{{asset('website/js/notifications/Lobibox.js')}}"></script>
       <script src="{{asset('website/js/classified/submit-form.js')}}"></script>
       <script src="{{asset('website/js/classified/login-form.js')}}"></script>
       <script src="{{asset('website/js/classified/rangeSlider.js')}}"></script>

       <script src="{{asset('website/js/vendor/emojionearea.min.js')}}"></script>
       <script src="{{asset('website/js/custom/emojionearea.js')}}"></script>
...
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js" type="text/javascript"></script>
  ...
  <script src="{{asset('website/js/custom/ekko-lightbox.js')}}"></script>
