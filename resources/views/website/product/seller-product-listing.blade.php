                                        ...
                                        <a href="{{url('product/detail',$product->slug)}}">
                                            <div class="product-media">
                                                <div class="product-imgdd">
                                                    @if ($product->image)
                                                        <img src="{{ asset('media/product-image/' . $product->image) }}" alt="product" height="142px" width="200">
                                                    @else
                                                        <img src="{{ asset('website/images/no-image.png') }}" alt="product" height="142px" width="200">
                                                    @endif
                                                </div>
                                            </div>
                                        </a>
