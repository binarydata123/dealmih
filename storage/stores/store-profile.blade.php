                    ...
                    <div class="blog-details-author">
                        <div class="col-md-5">
                            ...
                            <div class="author-intro mt40">
                                <a href="#!"><img 
                                    ...
                                    @endif
                                    @elseif($user->avatar)
                                    src="{{ asset('media/avatar/'.$store->avatar) }}"
                                   @else
                                 src="{{ asset('website/images/dea/job/dp.png') }}" @endif alt="author"></a>
                        ...
                        <div class="col-md-7">
                            ...
                            src="{{asset('media/company-cover-pic/'.$store->company_cover_pic)}}" @else
                             src="{{ asset('website/images/blog/03.jpg') }}" @endif class="img-responsive" alt="blog">
                             @else
                             {{-- no image  --}}
                             <img
                              src="{{ asset('website/images/dea/job/cover.png') }}" class="img-responsive shadow" alt="blog">
                             @endif
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="common-card shadow" id="review">
                                ...
                                <div class="ad-details-review">
                                    ...
                                    <form action="{{ url('/')}}" class="review-form mb20 formSubmit" method="post">
                                        @csrf
                                        <input type="text" hidden name="product_id" value="{{$productid}}" id="">
...
@endif
                                                ...
                                                <div class="review-head">
                                                    <div class="review-profile">
                                                        <a href="#" class="review-avatar"><img
                                                                ...
                                                                src="{{ asset('media/avatar/'.$review->user->avatar) }}"
                                                                 @else src="{{ asset('website/images/user.png') }}" @endif
                                                                 @endif
                                                                alt="review"></a>
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('website/images/ad.png') }}" alt="review">
                    </div>
