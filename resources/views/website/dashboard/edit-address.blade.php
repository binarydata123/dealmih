                        ...
                        <div class="container p40">
                            <div>
                                <div class="user-form-title mb30">
                                    <h4 class="fs20"><img
                                            src="{{ asset('website/images/arrow_back_black.svg') }}"> Edit New Address</h4>
                                        ...
                                        <div class="row mt20">
                                                        ...
                                                        <option value="">District</option>
                                                         @if($districts)
                                                            @foreach ($districts as $district)
                                                                ...
                                                                <option @if($addres->district_id == $district->district_id) selected @endif value="{{$district->district_id}}">{{ucwords($district->district_name)}}</option>
                                                            @endforeach
                                                         @endif
                                                    </select>
                                                    ...
                                                    <select class="form-control municipality" name="municipaliti_id">
                                                        ...
                                                        @if($muncipalities)
                                                            @foreach ($muncipalities as $muncipality)
                                                                <option @if($muncipality->municipality_id == $addres->municipaliti_id) selected @endif value="{{$muncipality->municipality_id}}">{{ucwords($muncipality->municipality_name)}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                <span class="error" style="color: red;"></span>
                                                    ...
                                                    <select class="form-control village" name="village_id">
                                                        ...
                                                        @if($villeges)
                                                            @foreach ($villeges as $villege)
                                                                <option @if($villege->id == $addres->village_id) selected @endif value="{{$villege->id}}">{{ucwords($villege->name)}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                <span class="error" style="color: red;"></span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="address_one" placeholder="Ward No.">{{$addres->address_one}}</textarea>
                                                <span class="error" style="color: red;"></span>
                                            ...
                                            <!-- <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="address_two" placeholder="Address line 2">{{$addres->address_two}}</textarea>
                                                <span class="error" style="color: red;"></span>
