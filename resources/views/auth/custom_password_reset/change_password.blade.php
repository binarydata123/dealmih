           ...
           <div class="container">
             <div>
                ...
                <ul class="user-form-option">
                   ...
                   <li><a href="{{url('auth/google')}}"><img src="{{asset('website/images/ui.svg')}}"><span class="text_set">Google</span></a></li>
                ...
                <p class="mbm20">Or Enter your login details below.</p>
                 ...
                 <form action="{{url('change-reset-password')}}" method="post">
                    @csrf
                   <div class="row">
                     ...
                     <div class="col-12 login-mobile">
                       ...
                       <div class="col-12 login-mobile">
                        <div class="form-group"><button type="submit" class="btn btn-inline"><span>Change password</span></button></div>
                     </div>
