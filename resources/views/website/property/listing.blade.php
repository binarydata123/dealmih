                    ...
                    @if($products->count() > 0)
                                    ...
                                    <div class="row bshadow mb-3 p15">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                @else
                                                    <a id="propety_data" href="{{url('property-detail',$product->slug)}}">
                                                        <img src="{{ asset('media/product-image/NoImageFound.png') }}"
                                                            class="iresponsive rimg">
                                                    </a>
                                                @endif
                                            </div>
                                            <div class="col-lg-6">
                                                @if (isset($product->media))
                                                    @foreach (collect($product->media)->forPage(1, 2) as $media)
                                                        <a id="propety_data" href="{{url('property-detail',$product->slug)}}">
                                                            <img src="{{ asset('media/product-multi-image/' . $media->file) }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px; object-fit: cover;"> 
                                                        </a>
                                                    @endforeach
                                                @else
                                                    <img src="{{ asset('media/product-image/NoImageFound.png') }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px; object-fit: cover;">
                                                    <br>
                                                    <br>
                                                    <img src="{{ asset('media/product-image/NoImageFound.png') }}" style="width: 100%;height: 168px;border-radius: 5px;margin-bottom: 15px; object-fit: cover;">
                                                @endif
                        ...
                        <div class="col-lg-4">
                            <div class="bshadow p15 mb-5">
                                ...
                                <img src="{{url('/media/webads-image',$webads->image)}}" class="mb-3">
                            ...
                            <div class="bshadow p15">
                                ...
                                <img src="{{url('/media/webads-image',$webad->image)}}" class="mb-3">
