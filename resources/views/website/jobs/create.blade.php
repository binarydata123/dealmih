...
<link rel="stylesheet" href="{{ asset('website/css/custom/create.css') }}">
...
@section('content')
    ...
    <section class="user-form-part">
        ...
        <div class="user-form-category">
            <!-- <div class="user-form-header"><a href="#"><img src="{{ asset('website/images/logo.png') }}" alt="logo"></a><a
                        ...
                        <div class="card px-0 pb-0 mb-3">
                            <form id="msform" action="{{ url('create/product') }}" method="post"
                                ...
                                @endif --}}
                                        @if ($slug == "services")
                                        <div class="col-lg-12">
                                            <textarea class="form-control service_about" 
                                            name="service_about" placeholder="About" style="height: 75px;" ></textarea>
                                            <span class="error" style="color:red;"></span>
                                        </div>
                                        <br>
                                        <div class="col-lg-12">
                                            <textarea class="form-control service_offered" 
                                            name="service_offered" placeholder="Service Offered" style="height: 75px;" ></textarea>
                                            <span class="error" style="color:red;"></span>
                                        </div>
                                        <br>
                                        <div class="col-lg-12">
                                            <textarea class="form-control area_service mb10xs" 
                                            name="area_service" placeholder="Area Services" style="height: 75px;" ></textarea>
                                            <span class="error" style="color:red;"></span>
                                        </div>
                                        ...
                                        <input id="timedemo" type="text" class="form-control" placeholder="hh:mm am/pm" Width="130px" name="availability_timing" />
                                            ...
                                            <div class="col-lg-9">
                                                <div class="form-group">
                                                    {{-- <input type="file" class="form-control ldash" name="image"
                                                        ...
                                                        <input type="hidden" name="image" class="hidden_imgdata" id="hidden_imgdata" value="">
                                                        {{-- <span class="error" style="color:red;"></span> --}}
                                                        <span title="attach file" class="attachFileSpan click-image" >
                                                        <img src="{{asset('website/images/surface1.svg')}}"> Browse or drag & drop photos here
                                                        </span>
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        @if ($slug != 'jobs' && $slug != 'services')
                                            <div class="row ml0 ">
                                                <div class="col-lg-6 rent_per_month">
                                                    <div class="form-group"><input type="text" name="price"
                                                            class="form-control price" placeholder="Buy Now Price" id="txtprice">
                                                        <span class="error" style="color: red;"></span>
                                                    </div>
                                                </div>

                                                <div class="col-lg-6 rent_per_month1">
                                                    <div class="form-group"><input type="text" name="price"
                                                            class="form-control price" placeholder="Rent Per Month" id="txtprice">
                                                        <span class="error" style="color: red;"></span>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if(isset($userDetail))
                                                        @if(count($muncipalities) > 0)
                                                            @foreach($muncipalities as $muncipality)
                                                                ...
                                                                value="{{$muncipality->municipality_id}}">{{$muncipality->municipality_name}}</option>
                                                            @endforeach
                                                        @endif
                                                    @endif
                                                    </select>
                                        ...
                                        <div class="col-lg-6">
                                            <h2 class="fs-title mb0">
                                                ...
                                                @elseif($slug == 'services') Service Information @endif </h2>
                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <img id="uploadPreview" class="iresponsive"
                                                        src="{{ asset('website/images/us.png') }}" />
                                                </div>
                                            </div>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="col-lg-7 business_detail" @if(!isset($user->username)) style="display: none;" @endif>
                                            <div class="mb30">
                                                <input type="radio" id="is_contact_person1"  value="1"   checked  
                                                    class="personalInfo personalInfoYes hidden_contact_person" name="is_contact_person">
                                        ...
                                        <div class="row ml0">
                                            <div class="col-lg-6">
                                                <div class="form-group"><input type="text" name="seller_first_name"
                                                        class="form-control seller_first_name" placeholder="Full Name" value="{{Auth::user()->username}}">
                                                    <span class="error" style="color: red;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group"><input type="text" name="seller_phone"
                                                    class="form-control seller_phone" placeholder="Phone Number" value="{{Auth::user()->phone_number}}">
                                                <span class="error" style="color: red;"></span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <select class="form-control" name="quantity">
                                                            <option option="">Select Quantity</option>
                                    ...
                                    <input type="button" name="next" data-id="4" class="next action-button"
                                        style="width: 48%;" value="Submit"><input type="button" name="previous"
                                        class="previous action-button-previous" value="Previous" style="width: 48%;">
                                </fieldset>
                            </form>
                        </div>
...
@section('js')
    ...
    {{-- <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script> --}}
    <script src="{{ asset('website/js/classified/product.js') }}"></script>
