                    ...
                    @if(Auth::check())
                        @if(Auth::user()->role_id == 1)
                            <li class="header-item hover_header">
                                ...
                                <p class="fs14 mtm5">{{ trans('global.dashboard') }}</p></a>
                            </li>
                        @endif
                       <!--  <li class="header-item hover_header">
   ...
   <!-- end mobilepopup -->
    ...
    <aside class="sidebar-part">
        <div class="sidebar-body">
            <div class="sidebar-header"><a href="{{ url('/') }}" class="sidebar-logo"><img
                        src="{{ asset('website/images/logo.png') }}" alt="logo"></a><button class="sidebar-cross"><i
    ...
    <nav class="mobile-nav">
        <div class="container">
            <div class="mobile-group">
               <a href="{{ url('/') }}" class="mobile-widget"><i
                    ...
                    <a href="{{url('wishlist')}}" class="mobile-widget"><i
                        class="fa fa-heart"></i><span>Wishlist</span></a>

                        @if(Auth::check())
                        <a href="{{url('profile')}}" id="welcomePopup" class="mobile-widget"><i
