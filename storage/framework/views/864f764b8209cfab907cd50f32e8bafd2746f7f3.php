...
<html lang="en">
   <head>
	...
	<?php } ?>
      ...
      <?php
        $setting_data = App\Models\Setting::getSettingData();
      ?>
...
<!-- Google tag (gtag.js) -->
   ...
   <body>
      ...
      <?php
      $lan = trans('global.signup') == 'साइन अप करें' ? true: false;
      // dd($lan);
      ?>
                    ...
                    <?php if(Auth::check()): ?>
                        <?php if(Auth::user()->role_id == 1): ?>
                            <li class="header-item hover_header">
                                ...
                                <p class="fs14 mtm5"><?php echo e(trans('global.dashboard')); ?></p></a>
                            </li>
                        <?php endif; ?>
                       <!--  <li class="header-item hover_header">
   ...
   <!-- end mobilepopup -->
    ...
    <aside class="sidebar-part">
        <div class="sidebar-body">
            <div class="sidebar-header"><a href="<?php echo e(url('/')); ?>" class="sidebar-logo"><img
                        src="<?php echo e(asset('website/images/logo.png')); ?>" alt="logo"></a><button class="sidebar-cross"><i
...
<!---mobile language----->
    ...
    <nav class="mobile-nav">
        <div class="container">
            <div class="mobile-group">
               <a href="<?php echo e(url('/')); ?>" class="mobile-widget"><i
                    ...
                    class="mobile-widget"><i class="fa fa-envelope"></i><span>Messages</span></a>
                        ...
                        <a href="<?php echo e(url('header-category')); ?>"
                    ...
                    <a href="<?php echo e(url('wishlist')); ?>" class="mobile-widget"><i
                        class="fa fa-heart"></i><span>Wishlist</span></a>

                        <?php if(Auth::check()): ?>
                        <a href="<?php echo e(url('profile')); ?>" id="welcomePopup" class="mobile-widget"><i
                        class="fa fa-user"></i><span>My profile</span></a>
                        <?php else: ?>
                        <a href="<?php echo e(url('profile')); ?>" id="welcomePopup" class="mobile-widget"><i
   ...
   <?php /**PATH /home/ubuntu/project/dealmih/resources/views/website/layout/app.blade.php ENDPATH**/ ?>