                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <img id="uploadPreview" class="iresponsive"
                                                           ...
                                                           src="{{ asset('media/company-logo/' . $user->businessDetails->company_log) }}" @endif
                                                        @else src="{{ asset('website/images/us.png') }}"
                                                            @endif />
                                                    </div>
                                                </div>
                                                <div class="col-lg-8">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row ml0">
                                                    <div class="col-lg-4">
                                                        ...
                                                        src="{{ asset('media/company-cover-pic/' . $user->businessDetails->company_cover_pic) }}" @endif
                                                            @else src="{{ asset('website/images/us.png') }}"
                                                                @endif />
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="form-card">
                                        ...
                                        @if ($user->documents)
                                            @foreach ($user->documents as $document)
                                              <!--   <img src="{{ asset('media/user-document/' . $document->document) }}" alt=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mt20 gallery-imgs">
                                                    ...
                                                    <span title="attach file" class="attachFileSpan"
                                                        ...
                                                        <img src="{{ asset('website/images/surface1.svg') }}">Browse or
                                                        drop file here
                                                    </span>
...
@section('js')
    ...
    <script src="{{ asset('website/js/classified/user-edit.js') }}"></script>
    <script>
        $('.district').select2({
            selectOnClose: true
        });
