...
<link rel="stylesheet" href="{{asset('website/css/custom/message.css')}}">
                                            ...
                                            <div class="ml20">
                                                ...
                                                <p>
                                                    <a href="{{ url('jobs-detail/' . $jobs->slug) }}">
                                                        ...
                                                        src="{{ asset('media/seller-image/' . $jobs->seller_image) }}"
                                                        @else src="{{ asset('website/images/favicon.png') }}"
                                                        @endif
                                                        class="mb20" width="48">
                                                    </a>
                                                </p>
                                    ...
                                    <a href="{{url('/jobs-detail',$product->productslug)}}">
                                        <div class="product-media">
                                            ...
                                            <div class="product-img">
                                                ...
                                                <img src="{{ asset('media/seller-image/' . $product->seller_image) }}" alt="product" id="data-img">
                                                @else
                                                <img src="{{ asset('website/images/no-image.png') }}" alt="product" id="data-img">
                                                @endif
                                            </div>
                                        </div>
                                    </a>
