            ...
            {{--  <div class="col-lg-6 _boxzoom">
               <div class="zoom-thumb">
                  ...
                  @if ($product->media)
                     ...
                     <li><img src="{{ asset('media/product-multi-image/' . $media->file) }}" alt=""></li>
               ...
               <div class="_product-images" align="center">
                  ...
                  @if ($product->image)
                  <img src="{{ asset('media/product-image/' . $product->image) }}" alt="details">
  ...
  <div class="row">
    <div class="col-md-12 col-md-offset-3">
     ...
     <div class="slider-for">
        ...
        <a href="{{ asset('media/product-image/' . $product->image) }}" class="item-slick"><img class="w-100 nav-single_image" src="{{ asset('media/product-image/' . $product->image) }}" alt="Alt"></a>

        @endif
        @foreach ($product->media as $media)
        <a href="{{ asset('media/product-multi-image/' . $media->file) }}" class="item-slick nav-single_image"><img class="w-100" src="{{ asset('media/product-multi-image/' . $media->file) }}" alt="Alt"></a>
        @endforeach
    </div>
    <div class="slider-nav mt-2 mb-2">
        @if ($product->image)

         <div class="item-slick mr-2"><img class="nav_gakllery w-100 h-50" src="{{ asset('media/product-image/' . $product->image) }}" alt="Alt" ></div>

        @endif
        @foreach ($product->media as $media)
        <div class="item-slick mr-2"><img class="nav_gakllery w-100 h-50" src="{{ asset('media/product-multi-image/' . $media->file) }}" alt="Alt" ></div>
        @endforeach
    </div>
   ...
   @else 
    ...
    <img class="w-100 mb-4" src="{{ asset('website/images/no-image.png') }}" alt="product">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mtm30">
                                    <!-- <a @if ($product->userList) href="{{url('store-profile/'.$product->userList->id.'/'.$product->id)}}" @endif > -->
                                        <img class="iresponsive" @if ($product->seller_image) src="{{ asset('media/seller-image/' . $product->seller_image) }}" @else src="{{ asset('website/images/us.png') }}" @endif alt="">
                                   <!--  </a> -->
                                </div>
                                        ...
                                        <a href="{{ url('product/detail/' . $similerproduct->slug) }}">
                                            <div class="product-img">
                                                @if ($similerproduct->image)
                                                    <img src="{{ asset('media/product-image/' . $similerproduct->image) }}"
                                                        alt="product">
                                                @else<img src="{{ asset('website/images/no-image.png') }}"
                                                        alt="product">
                                                @endif
                                            </div>
                                        </a>
 ...
 @php
                            ...
                            <a href="listing-detail.html">
                                <div class="product-media">
                                    <div class="product-img"><img
                                            src="{{ asset('website/images/product/03.jpg') }}" alt="product"></div>
                        ...
                        {{-- <div class="product-card">
                            <a href="listing-detail.html">
                                <div class="product-media">
                                    <div class="product-img"><img
                                            src="{{ asset('website/images/product/04.jpg') }}" alt="product"></div>
                        ...
                        {{-- <div class="product-card">
                            <a href="listing-detail.html">
                                <div class="product-media">
                                    <div class="product-img"><img
                                            src="{{ asset('website/images/product/05.jpg') }}" alt="product"></div>
                                    <div class="product-type">
                                        <div class="product-btn">
                                            <button type="button" title="Wishlist" class="far fa-heart"></button>
                                        </div>
                                ...
                                <div align="center">
                                    @if ($product->image)
                                        <img class="iresponsive bshadow"
                                            src="{{ asset('media/product-image/' . $product->image) }}" alt="">
                                    @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body 5" align="center">
                    ...
                    <img src="{{ asset('website/images/dea/bid_succes.png') }}" class="iresponsive mt10">
...
@section('js')
    ...
    <script src="{{ asset('website/js/classified/product-detail.js') }}"></script>
