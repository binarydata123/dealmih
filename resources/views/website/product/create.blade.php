                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <span title="attach file" class="attachFileSpan click-image">
                                        <img src="{{asset('website/images/surface1.svg')}}"> Upload Images/Photos
                                    </span>
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row ml0 mt20">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <img id="uploadPreview" class="iresponsive" src="{{ asset('website/images/us.png') }}" />
                                        <!-- @if(!empty(Auth::user()->avatar))

                                                    <img id="uploadPreview" class="iresponsive"
                                                        src="{{url('/media/avatar/'.Auth::user()->avatar)}}" />
