                        ...
                        <div class="col-lg-8">
                            <div class="row bshadow">
                                ...
                                <div class="col-lg-6 pr0">
                                    <div class="pr10">
                                        <img src="{{ asset('website/images/dea/property/l1.jpg') }}"
                                            class="iresponsive">
                                        <img src="{{ asset('website/images/dea/property/l2.jpg') }}"
                                ...
                                <div class="col-lg-6 pl0 pr0">
                                    <div class="pr10">
                                        ...
                                        <img src="{{ asset('website/images/dea/property/l3.jpg') }}"
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-lg-12 bshadow p10 bglight">
                                        <img src="{{ asset('website/images/dea/property/l4.jpg') }}"
