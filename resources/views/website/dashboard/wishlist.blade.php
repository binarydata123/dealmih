                            ...
                            <div class="col-lg-4 col-md-12">
                             ...
                             <div class="product-media">
                                 <div class="product-img"><img 
                                    ...
                                    src="{{ asset('media/product-image/' . $wishlist->product->image) }}" 
                                    @else
                                    src="{{asset('website/images/no-image.png')}}" 
                                    @endif
                                    alt="product"></div>
                             </div>
                            </a>
                               ...
                               <div class="product-content">     
                                 ...
                                 <div class="product-info text-cont">
                                   ...
                                   <div class="wishlist-move"><a href="#">
                                    ...
                                    <span class="cart" data-type="wishlist" data-id="{{$wishlist->product_id}}"><img src="{{asset('website/images/mvcart.svg')}}"></i>  Move to Cart</span>
                                    <span class="light-text">| 
                                      </span>&nbsp;
                                       @endif
                                      <a href="#"><span data-content="wishlist" data-id="{{$wishlist->id}}" class="delete"><img src="{{asset('website/images/delete.svg')}}">
                                 </i>  Delete</span></a></div>
